<h1 align="center">Engineering Coach</h1>

<p align="center">
<strong>better agentic engineering.</strong><br>
Analyze your AI coding and session data locally — any harness, one dashboard.
</p>
...
Engineering Coach is a focused, local-first coach for software engineers. It is derived
from Microsoft's [AI Engineering Coach](https://github.com/microsoft/AI-Engineering-Coach)
and retains the original MIT license and attribution. The goal of this repository is to
make the measurement, evidence, and coaching substrate easy to run and extend for code
